    ...
    def __init__(self, inpath, word_vocab=None, char_vocab=None, POS_vocab=None, NER_vocab=None, label_vocab=None, label_d_vocab=None, batch_size=60,
        ...
        if label_d_vocab is not None:
            for line in infile:
                ...
                label_d = items[0]
                label = items[1]
                sentence1 = items[2].lower()
                sentence2 = items[3].lower()
                ...
                if label_d_vocab is not None:
                    label_d_id = label_d_vocab.getIndex(label_d)
                    if label_d_id >= label_d_vocab.vocab_size: label_d_id = 0
                else:
                    label_d_id = int(label_d)
                ...
                instances.append((label, sentence1, sentence2, label_id, label_d_id, word_idx_1, word_idx_2, char_matrix_idx_1, char_matrix_idx_2,
            ...
            for line in infile:
                ...
                instances.append((label, sentence1, sentence2, label_id, label_d_id, word_idx_1, word_idx_2, char_matrix_idx_1,
                                  char_matrix_idx_2,
                                  POS_idx_1, POS_idx_2, NER_idx_1, NER_idx_2))
                # add indexed elements to the target list "instances"
            infile.close()
...
#########################
        ...
        for batch_index, (batch_start, batch_end) in enumerate(batch_spans):
            ...
            label_d_id_batch = None
            if label_d_vocab is not None: label_d_id_batch = []
            ...
            for i in xrange(batch_start, batch_end):
                (label, sentence1, sentence2, label_id, label_d_id, word_idx_1, word_idx_2, char_matrix_idx_1, char_matrix_idx_2,
                ...
                if label_d_vocab is not None:
                    label_d_id_batch.append(label_d_id)
            ...
            self.batches.append((label_batch, sent1_batch, sent2_batch, label_id_batch,label_d_id_batch, word_idx_1_batch, word_idx_2_batch,
